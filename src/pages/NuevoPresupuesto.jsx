  ...
  return (
    <div className="mx-auto flex max-w-[1400px] gap-8 px-8 py-8">
      <div className="min-w-0 flex-1">
        ...
        <div className="relative mt-6">
          <input
            ...
            className="w-full rounded-lg border border-black/15 px-4 py-2.5 text-sm text-black placeholder-black/40 outline-none transition-colors duration-150 focus:border-black"
          />
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-black/5">
              {items.length === 0 ? (
                ...
                items.map((item) => (
                  <tr key={item.id}>
                    <td className="px-4 py-3 text-black">{item.des}</td>
                    <td className="px-4 py-3 text-black/50">{item.mar}</td>
                    ...
                    <td className="px-4 py-3 text-right">
                      <input
                        ...
                        className="w-16 rounded-md border border-black/15 px-2 py-1 text-right text-sm outline-none focus:border-black"
                      />
                    </td>
                    <td className="px-4 py-3 text-right">
                      <input
                    ...
                    <td className="px-4 py-3 text-right">
                      <button
                        ...
                        className="rounded-md px-2 py-1 text-xs font-medium text-black/40 transition-colors duration-150 hover:text-black"
                      >
                        Eliminar
                      </button>
                    </td>
      ...
      <aside className="w-80 shrink-0">
        <div className="sticky top-8 space-y-6 rounded-lg border border-black/10 p-6">
